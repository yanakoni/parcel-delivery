    ...
    <Drawer anchor="right" open={open} onClose={toggle} sx={styles.drawerContainer}>
      ...
      <Box pl="18px" mt={3} display="flex" flexDirection="column" gap={4}>
        <Box display="flex" alignItems="center" justifyContent="space-between">
          ...
          <Button color="primary" component={Link} to="#" onClick={() => null} sx={styles.markAsReadButton}>
        ...
        <Box>
          ...
          {/*          .filter(*/}
          {/*            ({ group }) => activeTab === 'all' || group === activeTab,*/}
          {/*          )*/}
          {/*          .sort(*/}
          {/*            (a, b) =>*/}
